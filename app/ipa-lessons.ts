...
export function ipaLesson(level:string,part:string|undefined,number:number,language:'ru'|'en'|'ja'){
 ...
 return {core,detail,search,next,sources:level==='IP'?ipaIpSources[number]:level==='FE'&&part==='A'&&number===20?[{title:'Japan Copyright Act · Articles 19, 59',url:'https://www.japaneselawtranslation.go.jp/en/laws/view/4207'}]:undefined};
}
