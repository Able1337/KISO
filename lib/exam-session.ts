...
export type ExamPack = { schemaVersion: number; id: string; title: string; system: string; level: string; year: number; originalLanguage: string; durationSeconds: number; sourceUrl: string; publishedSubset?:boolean; parts?:ExamPart[]; questions: ExamQuestion[] };
