...
export type ExamPack = { schemaVersion: number; id: string; title: string; system: string; level: string; year: number; season?:string; originalLanguage: string; durationSeconds: number; sourceUrl: string; publishedSubset?:boolean; referencePage?:number; parts?:ExamPart[]; questions: ExamQuestion[] };
